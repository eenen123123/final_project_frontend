...
export default function BookMain() {
    ...
    "0003": [
      {
        ...
        status: "입고완료",
        desc: [
          "평가원 기출의 완벽한 4점 행동 영역 가이드라인 제시",
          "실전에서 바로 꺼내 쓰는 문제 조건 해석법",
        ],
      ...
      },
      {
        ...
        status: "입고완료",
        desc: [
          "기초부터 심화 킬러 로직까지 조건문 형태 분석 및 공략법",
          "확률과 통계 필수 유형 핵심 마스터 백",
        ],
    ...
    "0002": [
      {
        ...
        status: "입고완료",
        desc: [
          "EBS 수능특강 전 지문 고난도 구문 완벽 팩트 분석",
          "구조 분석을 통한 절대평가 1등급 메이커",
        ],
    ...
    "0004": [
      {
        ...
        status: "입고완료",
        desc: [
          "표 통계 문항 타임어택 완벽 극복을 위한 특수 알고리즘",
          "함정 선지 완벽 가려내기 트레이닝",
        ],
    ...
    "0005": [
      {
        ...
        status: "입고완료",
        desc: [
          "지구과학 천체 및 지질 파트 고난도 자료 완벽 해독",
          "실전 모의고사 연계용 심화 N제 세트",
        ],
  ...
  const currentBooks = (fullBookListBySubject[selectedArea] || []).filter(
    (b) =>
      selectedTeacher === "전체" ||
      b.teacher === selectedTeacher ||
      (b.teacher === "이do현" && selectedTeacher === "이도현"),
  );
          ...
          <table className="w-full border-collapse text-left">
            <tbody>
              ...
              <tr>
                ...
                <td className="px-4 py-3.5">
                  <div className="flex gap-1.5 flex-wrap">
                    {(teachersBySubject[selectedArea] ?? ["전체"]).map(
                      (teacher) => (
                        <FilterPill
                          key={teacher}
                          label={teacher}
                    ...
                    <div className="flex-shrink-0 flex justify-center md:justify-start">
                      ...
                      >
                        ...
                        <span className="text-[10px] font-medium tracking-tight text-right block opacity-80">
                          {book.teacher === "이do현" ? "이도현" : book.teacher}{" "}
                          저
                        </span>
                      </div>
                    </div>
