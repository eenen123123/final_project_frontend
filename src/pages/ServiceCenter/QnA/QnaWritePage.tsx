...
export default function QnaWritePage() {
  ...
  const handleSubmit = async ( ) => {
    if (!form.postSj.trim()) { alert('제목을 입력하세요.'); return; }
    if (!form.postCn.trim()) { alert('내용을 입력하세요.'); return; }
          ...
          <div className="flex-1 min-w-0 w-full">
            ...
            <div className="mt-5">
              ...
              <div className="mb-4">
                ...
                <select name="qnaCtgCd" value={form.qnaCtgCd} onChange={handleChange}
              ...
              <div className="mb-4">
                ...
                <input type="text" name="postSj" value={form.postSj} onChange={handleChange}
              ...
              <div className="mb-4">
                ...
                <textarea name="postCn" value={form.postCn} onChange={handleChange}
                  placeholder="문의 내용을 입력하세요." rows={10}
              ...
              <div className="mb-5 flex items-center gap-2">
                <input type="checkbox" id="secrYn" checked={form.secrYn === 'Y'}
              ...
              <div className="mb-6 border border-gray-200 rounded p-4">
                <label className="block text-xs font-semibold text-gray-700 mb-3">답변 알림 (추후에 구현예정)</label>
                <div className="flex flex-wrap gap-4">
                  {NOTI_OPTIONS.map((opt) => (
                    <label key={opt.id} htmlFor={opt.id}
                      ...
                      <input type="radio" id={opt.id} name="notiType" value={opt.id}
              ...
              <div className="flex items-center justify-center gap-3 border-t border-gray-200 pt-5">
                <button onClick={() => navigate('/customer/qna')}
