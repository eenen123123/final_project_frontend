    ...
    icon: (
      ...
      >
        <path
          strokeLinecap="round"
          strokeLinejoin="round"
          d="M2.5 7.5h19m-19 4h19m-19 5h14m1.5-11.5h-16A2.5 2.5 0 0 0 1.5 7.5v9A2.5 2.5 0 0 0 4.5 19h16a2.5 2.5 0 0 0 2.5-2.5v-9A2.5 2.5 0 0 0 20.5 5Z"
        />
      </svg>
    ),
  },
    ...
    icon: (
      ...
      >
        <path
          strokeLinecap="round"
          strokeLinejoin="round"
          d="M10.5 19.5h3m-6.75 2.25h10.5a2.25 2.25 0 0 0 2.25-2.25v-15a2.25 2.25 0 0 0-2.25-2.25H6.75A2.25 2.25 0 0 0 4.5 6.75v15a2.25 2.25 0 0 0 2.25 2.25Z"
        />
      </svg>
    ),
  },
              ...
              <div className="bg-[#e8e4da]">
                ...
                <div className="p-4 grid grid-cols-5 gap-3">
                  {faqs.map(({ id, question }) => (
                    ...
                    >
                      <p className="text-xs text-gray-400 font-mono mb-2">{String(id).padStart(2, "0")}</p>
            ...
            <div className="flex border border-gray-200 rounded mb-8 overflow-hidden" style={{ minHeight: "280px" }}>
              ...
              <div className="flex-1 border-r border-gray-200 flex flex-col items-center justify-center text-center p-6 gap-3">
                ...
                <div className="text-xs text-gray-600 leading-5 text-left">
                  <p>
                    <span className="font-bold">전화</span> 평일 09시~18시
                  </p>
                  <p>
                    <span className="font-bold">상담</span> 점심시간 : 12시~13시
                  </p>
                  <p className="text-gray-400">(주말, 공휴일 상담불가)</p>
                </div>
                <p className="text-xs text-gray-400 leading-5 text-center">
                  원하는 서비스를 빠르게 이용하도록
                  <br />각 서비스의 번호를 알려드립니다.
                </p>
