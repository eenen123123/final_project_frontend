  ...
  return (
    <>
      ...
      <Modal
        ...
        title="2026년 5월 학사 일정 전체보기"
        size="lg" // 💡 달력을 크게 보기 위해 모달 사이즈를 'lg'로 확장했습니다.
        footer={
          <button
...
<div className="md:col-span-3 border border-slate-100 rounded-2xl p-4 bg-white shadow-inner">
    ...
    <span className="text-sm font-black text-slate-800 tracking-tight">MAY 2026</span>
      ...
      <div className="grid grid-cols-7 gap-1.5">
        {["일", "월", "화", "수", "목", "금", "토"].map((d, idx) => (
          // 💡 일요일(idx 0)인 경우 text-red-500 적용
  ...
  return (
    <button
      ...
      `}
    >
      {/* 💡 핵심: span에 색상 관련 클래스를 직접 주어 호버 시에도 글씨가 유지되게 함 */}
