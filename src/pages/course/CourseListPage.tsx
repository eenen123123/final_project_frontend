...
export default function CourseListPage() {
  ...
  return (
    ...
    <div className="min-h-screen bg-gray-50">
      <main className="mx-auto px-6 py-10 space-y-5">
        {/* 상단 타이틀*/}
        <div className="mb-6 max-w-6xl mx-auto px-6">
          ...
          <p className="text-sm text-gray-500 mt-1">
            원하는 강좌를 검색하거나 과목별로 확인하실 수 있습니다.
          </p>
        </div>
            ...
            <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-5">
              ...
              <div className="flex flex-col gap-2.5">
                ...
                <button
                  ...
                  className="bg-slate-800 hover:bg-slate-900 text-white text-sm font-bold px-4 py-2.5 rounded-lg transition-all duration-150 cursor-pointer w-full flex items-center justify-center gap-2 shadow-sm"
                >
                  <SearchIcon />
                  검색
                </button>
                            ...
                            <button
                              ...
                              className={`text-xs font-medium px-2.5 py-1 rounded-full border transition-all duration-150 cursor-pointer ${
                                isActive
                                  ...
                                  : "bg-gray-50 border-gray-200 text-gray-600 hover:border-slate-300 hover:bg-slate-50 hover:text-slate-800"
                              }`}
                            >
                              {subj.subjNm}
                            </button>
