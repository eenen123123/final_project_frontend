...
export default function AlertDropdown({ items, onRead, onDismiss }: AlertDropdownProps) {
  ...
  return (
    <div className="relative" ref={ref}>
      <button onClick={() => setShow((v) => !v)} className="relative hover:text-gray-900 transition-colors">
      ...
      {show && (
        <div className="absolute right-0 top-8 w-80 max-w-[calc(100vw-2rem)] bg-white border border-gray-200 rounded-xl shadow-lg z-50 overflow-hidden">
          ...
          <div className="px-4 py-2.5 border-t border-gray-100 text-center">
            <button
              onClick={() => { setShow(false); navigate("/mypage/notifications"); }}
