...
const INIT_MESSAGES: AlertItem[] = [
  { id: 'm1', from: '관리자', message: '5월 모의고사 해설 라이브 일정을 확인해주세요.', read: false, important: false, date: '2026.05.22' },
  { id: 'm2', from: '관리자', message: '최근 구매하신 강좌의 구매내역 입니다.', read: false, important: false, date: '2026.05.21' },
  { id: 'm3', from: '임정환 선생님', message: '질문 주신 사회문화 A 2강 내용 답변 드렸습니다.', read: false, important: true, date: '2026.05.20' },
  { id: 'm4', from: '관리자', message: '수강 기간 연장 정책 변경 안내드립니다.', read: true, important: false, date: '2026.04.28' },
];
